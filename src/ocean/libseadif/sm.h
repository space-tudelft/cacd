 ...
 */
/*
 * Define constants and structure for the Canonic String Manager sm.c.
 */
...
#define SMMEANSTRLEN 6		/* expected length of String (incl. 0 byte) */
#define SMMINSIZ     1		/* minimum size of hash table */
#define SMMAXSIZ     50000	/* maximum size of hash table */
#define SMTABLESIZ   10000	/* default size of hash table */
