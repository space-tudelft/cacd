...
network de310 (terminal A, B, C, Y0, Y1, Y2, Y3, Y4, Y5, Y6, Y7)
{
...
network dfr11 (terminal D, R, CK, Q)
{
    @ invert (R, rn);
    @ and (rn, D, d2);
    @ invert (d2, d2n);
...
network dfa11 (terminal D, R, CK, Q)
{
    @ invert (D, dn);
    @ nor (CK, R, ckn);
    @ invert (ckn, cknn);
