...
network tbuf10 (terminal A, E, Y, vss, vdd)
{
    @ invert (A, 24);
    @ invert (E, 17);
    nenh w=23.2u l=1.6u (E, 22, vss);
    penh w=29.6u l=1.6u (17, 23, vdd);
    nenh w=23.2u l=1.6u (24, 22, Y);
    penh w=29.6u l=1.6u (24, 23, Y);
}

network tinv10 (terminal E, A, Y, vss, vdd)
{
    @ invert (E, 17);
    nenh w=23.2u l=1.6u (E, 22, vss);
    penh w=29.6u l=1.6u (17, 23, vdd);
    nenh w=23.2u l=1.6u (A, 22, Y);
    penh w=29.6u l=1.6u (A, 23, Y);
}
...
network Tbuf10 (terminal Y, A, E, vss, vdd)
{
    nenh w=23.2u l=1.6u (A, 24, vss);
    penh w=29.6u l=1.6u (A, 24, vdd);
    cap 15.69586f (A, vss);
    nenh w=23.2u l=1.6u (E, 17, vss);
    penh w=29.6u l=1.6u (E, 17, vdd);
    nenh w=23.2u l=1.6u (E, 22, vss);
    cap 32.98992f (E, vss);
    penh w=29.6u l=1.6u (17, 23, vdd);
    cap 148.0369f (17, vss);
    cap 32.1792f (22, vss);
    nenh w=23.2u l=1.6u (24, 22, Y);
    cap 95.16096f (23, vss);
    penh w=29.6u l=1.6u (24, 23, Y);
    cap 163.6397f (24, vss);
    cap 133.7273f (Y, vss);
    cap 180.4162f (vss, vss);
    cap 377.1192f (vdd, vss);
}

network Tinv10 (terminal E, A, Y, vss, vdd)
{
    nenh w=23.2u l=1.6u (E, 9, vss);
    penh w=29.6u l=1.6u (E, 9, vdd);
    nenh w=23.2u l=1.6u (E, 14, vss);
    cap 32.46736f (E, vss);
    penh w=29.6u l=1.6u (9, 15, vdd);
    cap 146.0705f (9, vss);
    cap 32.1792f (14, vss);
    nenh w=23.2u l=1.6u (A, 14, Y);
    cap 92.544f (15, vss);
    penh w=29.6u l=1.6u (A, 15, Y);
    cap 14.65074f (A, vss);
    cap 133.7273f (Y, vss);
    cap 127.6552f (vss, vss);
    cap 260.0737f (vdd, vss);
}
