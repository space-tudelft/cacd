...
typedef struct {
    ...
    unsigned int SENstatus : 1; /* indicates whether perturbation is in progress*/
    unsigned int SENacpertflag : 1; /* indicates whether the perturbation
    ...
    double SENpertfac;  /* perturbation factor (for active devices)*/
    ...
    double  **SEN_iRHS; /* RHS matrix (imag part)
                           contains the sensitivity values after SMPsolve*/
    int SENsize; /* stores the number of rows of each of the above 3 matrices */
