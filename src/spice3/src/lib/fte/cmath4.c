...
char * cx_and(char *data1, char *data2, int datatype1, int datatype2, int length)
{
...
char * cx_or(char *data1, char *data2, int datatype1, int datatype2, int length)
{
    double *dd1 = (double *) data1;
    double *dd2 = (double *) data2;
    double *d;
...
char * cx_not(char *data, int type, int length, int *newlength, int *newtype)
{
    double *d;
 ...
 */
char * cx_interpolate(char *data, int type, int length, int *newlength, int *newtype,
...
char * cx_deriv(char *data, int type, int length, int *newlength, int *newtype,
		struct plot *pl, struct plot *newpl, int grouping)
{
    double *scratch;
    double *spare;
