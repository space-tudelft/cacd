...
register CKTcircuit *ckt;
{
    ...
    int xrev;
    double A0;
    double Apert = 0; /* prevent compiler uninitialized warning */
    double DELA;
    double DELAinv;
    double gdpr0;
    double gspr0;
        ...
        for(here = model->MOS2instances; here!= NULL;
            ...
            *(ckt->CKTrhsOp+here->MOS2bNode) -
            ...
            printf("source = %d, sourceprm = %d, body = %d, senparmno = %d\n",
                    here->MOS2sNode, here->MOS2sNodePrime, here->MOS2bNode, here->MOS2senParmNo);
            ...
            *(ckt->CKTstate0 + here->MOS2vbd) = vbdOp;
            ...
            printf("xcgs0 = %.7e, xcgd0 = %.7e, xcgb0 = %.7e, ", xcgs0, xcgd0, xcgb0);
...
load:
            ...
            for(iparmno = 1;iparmno<=info->SENparms;iparmno++){
                ...
                *(info->SEN_iRHS[here->MOS2dNodePrime] + iparmno) -=
                ...
                printf("DvDp = %.5e, DELAinv = %.5e, flag = %d, ", DvDp, DELAinv, flag);
