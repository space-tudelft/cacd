...
{
unsigned exact;
double lolimit1,lolimit2 = 0,hilimit1,hilimit2 = 0;
double delta1, delta2;

double h1dummy1, h1dummy2;
double h1lovalue1,h1lovalue2,h1hivalue1,h1hivalue2;

double h2dummy1 = 0, h2dummy2;
double h2lovalue1 = 0,h2lovalue2,h2hivalue1 = 0,h2hivalue2;

double h3dummy1 = 0, h3dummy2;
double h3lovalue1,h3lovalue2,h3hivalue1 = 0,h3hivalue2;

double exparg, besselarg = 0, expterm, bessi1overxterm, bessi0term;
double expbetaTterm = 0, alphasqTterm = 0;
double h1relval, h2relval = 0, h3relval = 0;
int doh1=1, doh2=1, doh3=1;
