    ...
    */
{
    ...
    double qf1,qf2,qf3;
    double lf2,lf3;
    double v1d, v2d, i1d, i2d, max, min;
    double dummy1, dummy2;
    int isaved = 0; /* SdeG. prevent compiler warning */
    int tdover = 0; /* SdeG. prevent compiler warning */
    register int i;

    v1d = v2d = i1d = i2d = max = min = 0; /* SdeG. prevent compiler warning */
