...
CKTcircuit *ckt;
{
    ...
    double qbx0;
    double qbx;
    double DqbeDp = 0; /* init, prevent compiler warning */
    double DqbcDp = 0; /* init, prevent compiler warning */
    double DqcsDp = 0; /* init, prevent compiler warning */
    double DqbxDp = 0; /* init, prevent compiler warning */
    double Osxpbe;
    double Osxpbc;
    double Osxpcs;
    double Osxpbx;
