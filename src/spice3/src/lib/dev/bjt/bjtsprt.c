	...
	GENmodel *inModel;
{
    ...
    for( ; model != NULL; model = model->BJTnextModel ) {
		...
		(char*)CKTnodName(ckt,here->BJTcolNode),
		(char*)CKTnodName(ckt,here->BJTbaseNode),
		(char*)CKTnodName(ckt,here->BJTemitNode));
