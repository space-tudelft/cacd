...
double Vgst, dVgst_dVg, dVgst_dVb, dVgs_eff_dVg, Nvtm, Vtm;
...
qcheq = qgate = qbulk = qdrn = 0; /* SdeG. prevent compiler warning */
gqdef = gcqgb = gcqdb = gcqsb = gcqbb = 0; /* SdeG. prevent compiler warning */
