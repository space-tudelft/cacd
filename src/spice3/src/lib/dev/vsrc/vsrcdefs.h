...
typedef struct sVSRCinstance {
    ...
    double *VSRCibrIbrptr;  /* pointer to sparse matrix element at
		...
		/* flags to indicate: */
    unsigned VSRCdcGiven     : 1; /* dc value given */
    unsigned VSRCacGiven     : 1; /* ac keyword given */
    unsigned VSRCacMGiven    : 1; /* ac magnitude given */
    unsigned VSRCacPGiven    : 1; /* ac phase given */
    unsigned VSRCfuncTGiven  : 1; /* function type given */
    unsigned VSRCcoeffsGiven : 1; /* function coeffs given */
    unsigned VSRCdGiven      : 1; /* source is disto input */
    unsigned VSRCdF1given    : 1; /* source is f1 dist input */
    unsigned VSRCdF2given    : 1; /* source is f2 dist input */
} VSRCinstance;
...
typedef struct sVSRCmodel {
    ...
    struct sVSRCmodel *VSRCnextModel; /* pointer to next possible model in linked list */
    VSRCinstance * VSRCinstances; /* pointer to list of instances that have this model */
