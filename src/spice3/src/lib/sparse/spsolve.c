 ...
 */
#if spCOMPLEX AND spSEPARATED_COMPLEX_VECTORS
void spSolveTransposed(char *eMatrix, RealVector RHS, RealVector Solution, RealVector iRHS, RealVector iSolution)
#else
void spSolveTransposed(char *eMatrix, RealVector RHS, RealVector Solution)
#endif
{
    MatrixPtr Matrix = (MatrixPtr)eMatrix;
    register ElementPtr pElement;
