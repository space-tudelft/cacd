...
extern void usage (char *pname);
extern void comments (double r, double l, double g, double c, double ctot, double cm,
...
void comments (double r, double l, double g, double c, double ctot, double cm,
		double lm, double k, char *name, int num, double len)
{
