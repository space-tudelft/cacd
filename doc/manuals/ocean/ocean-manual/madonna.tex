...
{No, Madonna is quite possessive. She wants to do everything herself.
...
database.  The program \tool{sea} is a kind of bodyguard to \tool{madonna}: it
checks the correctness of your input. Only if everything is correct, it calls
\tool{madonna} to look at your circuit. 
...
name' option to write it under a different name). Just type \type{sea -h} to
see all the options.  
